...
# Base de Dados: ws_php
# Tempo de Geração: 2017-05-31 18:48:28 +0000
# ************************************************************
...
/*!40000 ALTER TABLE `app_cidades` DISABLE KEYS */;

INSERT INTO `app_cidades` (`cidade_id`, `estado_id`, `cidade_nome`, `cidade_uf`)
VALUES
...
/*!40000 ALTER TABLE `app_cidades` ENABLE KEYS */;
UNLOCK TABLES;


# Dump da tabela app_empresas
# ------------------------------------------------------------
...
INSERT INTO `app_empresas` (`empresa_id`, `empresa_title`, `empresa_name`, `empresa_capa`, `empresa_ramo`, `empresa_sobre`, `empresa_site`, `empresa_facebook`, `empresa_endereco`, `empresa_uf`, `empresa_cidade`, `empresa_categoria`, `empresa_status`, `empresa_views`, `empresa_date`, `empresa_last_view`)
VALUES
	...
	(27,'Headphone Pub','headphone-pub-1','empresas/2014/04/headphone-pub-1.png','Perfumes','Teste','http://www.artejiujitsu.com','arttejuu','Av. Pinheiro / 1398',21,5077,'onde-comprar',0,NULL,'2014-04-02 07:25:13',NULL);

/*!40000 ALTER TABLE `app_empresas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump da tabela app_estados
# ------------------------------------------------------------
...
INSERT INTO `app_estados` (`estado_id`, `estado_nome`, `estado_uf`, `estado_regiao`)
VALUES
	(1,'Acre','AC','Norte'),
...
INSERT INTO `ws_categories` (`category_id`, `category_parent`, `category_name`, `category_title`, `category_content`, `category_date`, `category_views`, `category_last_view`)
VALUES
	(1,NULL,'noticias','Notícias','Notícias sobre o mundo da tecnologia, esportes, eventos e tudo que aconteceu você encontra aqui! Conteúdo de primeira para você ficar por dentro das últimas! Cidade Online, o seu portal da cidade!','2014-03-31 07:14:13',24,'2014-04-03 20:11:39'),
...
INSERT INTO `ws_posts` (`post_id`, `post_name`, `post_title`, `post_content`, `post_cover`, `post_date`, `post_author`, `post_category`, `post_cat_parent`, `post_views`, `post_last_views`, `post_status`, `post_type`)
VALUES
...
# Dump da tabela ws_posts_gallery
# ------------------------------------------------------------
...
LOCK TABLES `ws_posts_gallery` WRITE;
/*!40000 ALTER TABLE `ws_posts_gallery` DISABLE KEYS */;

INSERT INTO `ws_posts_gallery` (`post_id`, `gallery_id`, `gallery_image`, `gallery_date`)
VALUES
	(7,1,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-4283d.jpg','2014-02-11 21:37:18'),
	(7,2,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-946d1.jpg','2014-02-11 21:37:19'),
	(7,3,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-e2a64.jpg','2014-02-11 21:37:19'),
	(7,4,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-9599c.jpg','2014-02-11 21:37:19'),
	(7,5,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-53282.jpg','2014-02-11 21:37:19'),
	(7,6,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-2f14f.jpg','2014-02-11 21:37:20'),
	(7,7,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-fc9af.jpg','2014-02-11 21:37:20'),
	(7,8,'images/2014/02/sochi-2014-fotos-sensuais-de-atletas-russas-despertam-polemica-gb-7-7102d.jpg','2014-02-11 21:37:20'),
	(20,9,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-749e3.jpg','2014-03-31 06:12:59'),
	(20,10,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-17c88.jpg','2014-03-31 06:12:59'),
	(20,11,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-d339d.jpg','2014-03-31 06:13:00'),
	(20,12,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-1d95f.jpg','2014-03-31 06:13:00'),
	(20,13,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-33fbc.jpg','2014-03-31 06:13:00'),
	(20,14,'images/2014/03/twitter-testa-novo-layout-similar-a-facebook-e-google-gb-20-a6a42.jpg','2014-03-31 06:13:00');

/*!40000 ALTER TABLE `ws_posts_gallery` ENABLE KEYS */;
UNLOCK TABLES;


# Dump da tabela ws_siteviews
# ------------------------------------------------------------
...
LOCK TABLES `ws_siteviews` WRITE;
/*!40000 ALTER TABLE `ws_siteviews` DISABLE KEYS */;

INSERT INTO `ws_siteviews` (`siteviews_id`, `siteviews_date`, `siteviews_users`, `siteviews_views`, `siteviews_pages`)
VALUES
...
# Dump da tabela ws_siteviews_agent
# ------------------------------------------------------------
...
LOCK TABLES `ws_siteviews_agent` WRITE;
/*!40000 ALTER TABLE `ws_siteviews_agent` DISABLE KEYS */;

INSERT INTO `ws_siteviews_agent` (`agent_id`, `agent_name`, `agent_views`, `agent_lastview`)
VALUES
	(1,'Chrome',125,'2017-05-31 15:39:44'),
...
# Dump da tabela ws_siteviews_online
# ------------------------------------------------------------
...
LOCK TABLES `ws_siteviews_online` WRITE;
/*!40000 ALTER TABLE `ws_siteviews_online` DISABLE KEYS */;

INSERT INTO `ws_siteviews_online` (`online_id`, `online_session`, `online_startview`, `online_endview`, `online_ip`, `online_url`, `online_agent`, `agent_name`)
VALUES
	...
	(5,'9prrme55pk98e1bcl7rqifpp50','2014-04-02 14:30:35','2014-04-02 14:50:46','::1','/cursos/ws_php/modulos/12-projeto-final/artigo/queridinho-local-surpreende-e-e-ouro-no-snowboard','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.154 Safari/537.36','Chrome'),
	(6,'pj844a4avgf7h44ho1sggntam2','2014-04-03 13:59:59','2014-04-03 20:31:39','::1','/cursos/ws_php/modulos/12-projeto-final//categoria/noticias','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.154 Safari/537.36','Chrome'),
	(7,'anfffg4f3btc5a2id6ndu5hkg3','2017-05-31 15:39:44','2017-05-31 16:00:46','::1','/cursos/ws_php/modulos/12-projeto-final/admin/home.php','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36','Chrome');

/*!40000 ALTER TABLE `ws_siteviews_online` ENABLE KEYS */;
UNLOCK TABLES;


# Dump da tabela ws_users
# ------------------------------------------------------------
...
INSERT INTO `ws_users` (`user_id`, `user_name`, `user_lastname`, `user_email`, `user_password`, `user_registration`, `user_lastupdate`, `user_level`)
VALUES
	(1,'Admin','Ws PHP','admin@wsphp.com.br','e10adc3949ba59abbe56e057f20f883e','2014-02-11 11:14:04','2014-02-11 21:30:45',3);
