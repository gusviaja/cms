...
<div class="container">
	...
	<div class="col-md-3">
	<aside>
        <h2 class="boxtitle">Estatísticas de Acesso:</h2>
        <article class="sitecontent boxaside">
            <h3 class="boxsubtitle">Conteúdo:</h1>
            <?php
            //OBJETO READ
            $read = new Read;
            ...
            <ul class="todo-list">
                <li class=""><span><?= $Views; ?></span> visitas</li>
                <li class=""><span><?= $Users; ?></span> usuários</li>
                <li class=""><span><?= $Pages; ?></span> pageviews</li>
                <li class=""><span><?= $Posts; ?></span> posts</li>
                <li class=""><span><?= $Empresas; ?></span> empresas</li>
        ...
        <article class="useragent boxaside">
            <h3 class="boxsubtitle">Navegador:</h3>
    ...
    <section class="content_statistics">
        <h2 class="boxtitle">Publicações:</h2>
        <section>
            <h3 class="boxsubtitle">Artigos Recentes:</h3>
            <?php
            ...
            if ($read->getResult()):
                foreach ($read->getResult() as $re):
                    ...
                    <article>
                        ...
                        <h3><a target="_blank" href="../artigo/<?= $post_name; ?>" title="Ver Post"><?= Check::Words($post_title, 10) ?></a></h3>
        ...
        <section>
            <h3 class="boxsubtitle">Artigos Mais Vistos:</h3>
