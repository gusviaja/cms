...
<div class="content form_create">
    <article>
        ...
        if (!empty($_SESSION['errCapa'])):
            NIErro($_SESSION['errCapa'], E_USER_WARNING);
            unset($_SESSION['errCapa']);
        endif;

        $checkCreate = filter_input(INPUT_GET, 'create', FILTER_VALIDATE_BOOLEAN);
        if ($checkCreate && empty($cadastra)):
            NIErro("O post <b>{$post['post_title']}</b> foi cadastrado com sucesso no sistema!", NI_ACCEPT);
        endif;
        ?>
        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="label gbform" id="gbfoco">
                ...
                if ($delGb):
                   ...
                   NIErro($DelGallery->getError()[0], $DelGallery->getError()[1]);
