...
class View {
    ...
    /**
     * <strong>Carregar Template View:</strong> Dentro da pasta do seu template, crie a pasta _tpl e armazene as
    ...
    /**
     * <strong>Exibir Template View:</strong> Execute um foreach com um getResult() para coleta de dados informe o envelope
    ...
    /**
     * <strong>Carregar PHP View:</strong> Tendo um arquivo PHP com echo em variáveis extraídas, utilize esse método
     * para incluir, povoar e exibir o mesmo. Basta informar o caminho do arquivo<strong>.inc.php</strong> e um
