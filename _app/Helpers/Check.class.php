...
class Check {
    ...
    /**
     * <strong>Tranforma URL:</strong> Tranforma uma string no formato de URL amigável e retorna o a string convertida!
    ...
    /**
     * <strong>Tranforma Data:</strong> Transforma uma data no formato DD/MM/YY em uma data no formato TIMESTAMP!
    ...
    /**
     * <strong>Limita os Palavras:</strong> Limita a quantidade de palavras a serem exibidas em uma string!
    ...
    /**
     * <strong>Obter categoria:</strong> Informe o name (url) de uma categoria para obter o ID da mesma vindo do BD.
    ...
    public static function CatByName($CategoryName) {
        $read = new Read;
        $read->ExeRead('ni_categories', "WHERE category_name = :name", "name={$CategoryName}");
        if ($read->getRowCount()):
