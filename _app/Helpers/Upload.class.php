...
class Upload {
    ...
    /**
     * <strong>Enviar Imagem:</strong> Basta envelopar um $_FILES de uma imagem e caso queira um nome e uma largura personalizada.
    ...
    /**
     * <strong>Enviar Mífia:</strong> Basta envelopar um $_FILES de uma mídia e caso queira um nome e um tamanho personalizado.
    ...
    /**
     * <strong>Verificar Upload:</strong> Executando um getResult é possível verificar se o Upload foi executado ou não. Retorna
    ...
    /**
     * <strong>Obter Erro:</strong> Retorna um array associativo com um code, um title, um erro e um tipo.
