...
class Read extends Conn {
    ...
    /**
     * <strong>Exe Read:</strong> Executa uma leitura simplificada com Prepared Statments. Basta informar o nome da tabela,
    ...
    private function Execute() {
        ...
        try {
            ...
            $this->Result = null;
            NIErro("<b>Erro ao Ler:</b> {$e->getMessage()}", $e->getCode());
        }
    }
